...
mixin _$SecuritySetupState {
 ...
 bool get pinSet; bool get biometricAvailable; bool get biometricSet;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SecuritySetupState&&(identical(other.pinSet, pinSet) || other.pinSet == pinSet)&&(identical(other.biometricAvailable, biometricAvailable) || other.biometricAvailable == biometricAvailable)&&(identical(other.biometricSet, biometricSet) || other.biometricSet == biometricSet));
}


@override
int get hashCode => Object.hash(runtimeType,pinSet,biometricAvailable,biometricSet);

@override
String toString() {
  return 'SecuritySetupState(pinSet: $pinSet, biometricAvailable: $biometricAvailable, biometricSet: $biometricSet)';
}
...
@useResult
$Res call({
 bool pinSet, bool biometricAvailable, bool biometricSet
});
...
/// Create a copy of SecuritySetupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pinSet = null,Object? biometricAvailable = null,Object? biometricSet = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool pinSet,  bool biometricAvailable,  bool biometricSet)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SecuritySetupState() when $default != null:
return $default(_that.pinSet,_that.biometricAvailable,_that.biometricSet);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool pinSet,  bool biometricAvailable,  bool biometricSet)  $default,) {final _that = this;
switch (_that) {
case _SecuritySetupState():
return $default(_that.pinSet,_that.biometricAvailable,_that.biometricSet);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool pinSet,  bool biometricAvailable,  bool biometricSet)?  $default,) {final _that = this;
switch (_that) {
case _SecuritySetupState() when $default != null:
return $default(_that.pinSet,_that.biometricAvailable,_that.biometricSet);case _:
  return null;
...
class _SecuritySetupState extends SecuritySetupState {
  const _SecuritySetupState({required this.pinSet, required this.biometricAvailable, required this.biometricSet}): super._();
...
/// Create a copy of SecuritySetupState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pinSet = null,Object? biometricAvailable = null,Object? biometricSet = null,}) {
